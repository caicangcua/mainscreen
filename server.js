...
//        var Netdata = JSON.parse(JSON.stringify(messageData.data));
//        Netdata['act'] = 'putgeo'; Netdata['id'] = 'j7+'; Netdata['logtime'] = messageData.message_id;
//        request.post(
//            'http://brickapi.dnd.vn/api/githubcom/',  // 'http://192.168.1.91:2432/api/githubcom/',
//            { json: Netdata },
//            function (error, response, body) {
//                if (!error && response.statusCode == 200) {
//                    io.sockets.emit('geoloc', messageData.data);
//                }
//            }
//        );
